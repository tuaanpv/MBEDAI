...
#ifndef __YOLO_TRAFFIC_H__
#define __YOLO_TRAFFIC_H__
...
class YOLOTraffic: public Detection
{
    public:
        YOLOTraffic(float conf_threshold = 0.5, float nms_threshold = 0.5)
        {
            _obj_name = "[YOLO] ";
            std::cout << _obj_name << std::endl;

            _class_file = "../model/yolo/traffic_signs/signs.names.txt";
            _model_file = "../model/yolo/traffic_signs/yolov4-tiny_training_last.weights";
            _config_file = "../model/yolo/traffic_signs/yolov4-tiny_training.cfg";

            // _class_file = "../model/yolo/road_signs/signs_classes.txt";
            // _model_file = "../model/yolo/road_signs/yolov4-rds_best_2000.weights";
            // _config_file = "../model/yolo/road_signs/yolov4-rds.cfg";
    ...
    protected:
                                        ...
                                        std::vector<cv::Rect> &boxes)
        {
            ...
            cv::dnn::blobFromImage(frame, blob, 0.00392, cv::Size(inpWidth, siz.height), cv::Scalar(0,0,0), true, false);
